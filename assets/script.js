...
searchCity.addEventListener("submit", function(){

var requestCurrentWeather='https://api.openweathermap.org/data/2.5/weather?q='+city+',USA&units=imperial&appid='+api;
...
var request5dayWeather = 'https://api.openweathermap.org/data/2.5/forecast?q='+city+',USA&units=imperial&appid='+api;
